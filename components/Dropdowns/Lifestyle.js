...
const Lifestyle = () => {
  ...
  return (
    ...
    <div className="fixed bg-gray-800 text-white h-[26.8rem] shadow-xl shadow-black
      flex justify-evenly w-[100%] mr-[22.4rem] py-[5%]">
       ...
       />
       <h2 className="text-sm font-bold fixed z-40 top-[15rem] pl-[9rem]
         opacity-[0.5] font-serif
